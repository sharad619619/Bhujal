...
export const demoMediaAssets: MediaAsset[] = [
  ...
  },
  {
    ...
    "type": "image",
    "caption": "Food preparation test exhibiting yellowish staining following boiling with untreated shallow aquifer water",
    "source": "Synthetic Environmental Simulation / CSIR Protocol",
    "license": "Simulated Food Safety Telemetry",
    "attribution": "Environmental Health Simulation Unit",
...
export const demoCommunityReports: CommunityReport[] = [
  ...
  },
  {
    ...
    hasPhoto: true,
    photoUrl: 'https://images.unsplash.com/photo-1536304993881-ff6e9eefa2a6?auto=format&fit=crop&w=800&q=80',
    mediaAssetId: 'MA-021',
    isSynthetic: true,
    reporterType: 'Ward Resident',
